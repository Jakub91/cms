...
$di->setShared('config', function () {
    return include BASE_PATH . "/phalcon/config.php";
});
...
$di->setShared('view', function () use ($di) {
    ...
    $view->registerEngines(array(
        ".latte" => function ($view, $container) use ($config) {
            ...
            $latte->setTempDirectory ($config->application->cacheDir . '/latte');
            return $latte;
        },
    ));
    return $view;
...
$di->set('dispatcher', function() {
    ...
    $eventsManager->attach("dispatch:beforeExecuteRoute", new AdminPlugin());

    /**
     * Check if controller or action exist, if not throw error
     */
...
$di->set('router', function() {
    return include BASE_PATH . '/phalcon/router.php';
});